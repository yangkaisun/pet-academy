...
A tiny, cozy learning game built with Phaser. Children choose a storybook-realistic dog, cat, or bunny in one of three colors; complete five-question Math, Gym, Science, History, and Art lessons; progress through multiple learning levels; earn and spend stars in a prize shop; collect stickers, hats, wands, and outfits; and save progress in the browser.
