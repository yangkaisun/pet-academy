...
- A pet naming step.
- One school location with five playable classes: Math, Gym, Science, History, and Art.
...
- School subjects beyond Math, Gym, Science, History, and Art.
...
All pets share a consistent storybook-realistic style with species-specific details:
...
Gym class practices movement and sports vocabulary through pictures. It contains three levels:

- Movers: identify familiar physical activities.
- Sports Stars: identify sports from their equipment.
- Adventure: identify less familiar outdoor and athletic activities.
...
| Space Sticker | Room decoration | 12 stars |
...
7. **School map** — Choose Math, Gym, Science, History, or Art, plus a level where available.
...
- A player can finish any 5-question class in under 5 minutes.
...
5. Build illustrated Gym question levels.
6. Add reusable question pools for Science, History, and Art.
7. Add stars, experience, and the results screen.
8. Add pet selection, color selection, and naming.
9. Add unlockable outfits, the Star Shop, and premium room rewards.
10. Save and restore progress locally.
11. Add polish: animation, sound, read-aloud support, accessibility, and additional rewards.
